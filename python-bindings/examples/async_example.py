...
async def test_async_functions():
    ...
    if not hasattr(dcap_qvl, 'get_collateral'):
        print("❌ Async functions not available. Make sure the library was compiled with 'report' feature.")
        return
    ...
    try:
        result = await dcap_qvl.get_collateral_and_verify(quote_data, None)  # None = use default PCS
